...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("In prder to send Telegram message enter 3");
            ...
            if(message instanceof SmsMessage){
                ...
                ((SmsMessageService) messageService).sendSmsMessage((SmsMessage) message);
            }else if(message instanceof EmailMessage){
                messageService = new EmailMessageService();
                ((EmailMessageService) messageService).sendEmailMessage((EmailMessage) message);
            } else if (message instanceof TelegramMessage) {
                messageService = new TelegramMessageService();
                ((TelegramMessageService) messageService).sendTelegramMessage((TelegramMessage) message);
